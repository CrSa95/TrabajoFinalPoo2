...
public class ReporteBuqueTest {
	...
	void generarReporteBuqueGeneraHtmlCompletoEsperado() {
		...
		when(terminalMock.cargasImportadasEnViaje(viajeMock)).thenReturn(List.of(cargaImport1, cargaImport2));
		when(terminalMock.cargasExportadasEnViaje(viajeMock)).thenReturn(List.of(cargaExport1, cargaExport2));
